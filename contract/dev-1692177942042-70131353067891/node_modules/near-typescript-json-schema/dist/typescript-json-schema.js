...
var JsonSchemaGenerator = (function () {
    ...
    JsonSchemaGenerator.prototype.getUnionDefinition = function (unionType, prop, unionModifier, definition) {
        ...
        for (var _i = 0, _a = unionType.types; _i < _a.length; _i++) {
            ...
            if (value !== undefined) {
                ...
                var def = this.getTypeDefinition(valueType, undefined, undefined, symbol, symbol);
    ...
    JsonSchemaGenerator.prototype.getSchemaForSymbol = function (symbolName, includeReffedDefinitions, clean) {
